...
import com.rey.material.widget.CircularProgressView;
...
@ShortName("bcCircularProgressView")
...
public class bcCircularProgressView extends AbsObjectWrapper<CircularProgressView>  implements DesignerCustomView {
	private BA ba;
	...
	public void _initialize(final BA ba, Object activityClass, String EventName) {
		...
		this.ba = ba;
		this.setObject(new CircularProgressView(ba.context));
