...
public class bcRadiobutton extends ViewWrapper<RadioButton>  implements DesignerCustomView {
	private BA ba;
	...
	public void _initialize(final BA ba, Object activityClass, String EventName) {
		...
		this.ba = ba;
		this.setObject(new RadioButton(ba.context));
		//this.getObject()
	...
	public void setSelected(boolean selected){
		this.getObject().setSelected(selected);
	}
	public void toggle(){
		this.getObject().toggle();
	}
	public void setCheckedImmediately(boolean checked){
		this.getObject().setCheckedImmediately(checked);
	}
