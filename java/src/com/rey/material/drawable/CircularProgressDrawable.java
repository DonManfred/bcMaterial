...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	private int mKeepDuration = 500;	
	private float mInStepPercent = 0.1f;
	private int[] mInColors;
	private int mInAnimationDuration = 2000;
	private int mOutAnimationDuration = 1000;
	...
	public static class Builder{
		...
		private int[] mInColors = new int[]{0xFFB5D4FF, 0xFFDEEAFC, 0xFFFAFFFE};
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
			...
			if((resId = a.getResourceId(R.styleable.CircularProgressDrawable_cpd_strokeColors, 0)) != 0){
				...
				colors[0] = Color.parseColor("#FF3F8AF8");
				colors[1] = Color.parseColor("#FFD8433C");
				colors[2] = Color.parseColor("#FFF2AF3A");
				colors[3] = Color.parseColor("#FF279B5E");
				strokeColors(colors);
			}
			...
			if((resId = a.getResourceId(R.styleable.CircularProgressDrawable_cpd_inStepColors, 0)) != 0){
				...
				colors[0] = Color.parseColor("#FFB5D4FF");
				colors[1] = Color.parseColor("#FFDEEAFC");
				colors[2] = Color.parseColor("#FFFAFFFE");
				inStepColors(colors);
			}
