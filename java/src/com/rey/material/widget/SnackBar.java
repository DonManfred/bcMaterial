...
public class SnackBar extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        addView(mText, new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        addView(mAction, new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
	...
	private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
		...
		msingleLine = a.getBoolean(R.styleable.SnackBar_sb_singleLine, true);
